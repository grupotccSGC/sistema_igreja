...
<?php //mensagem de erro abaixo
      ...
      <?php if(!empty($da)){
          echo form_open('Welcome/atualiza_despesas');
        }else{
          echo form_open('Welcome/cadastro_despesas');
        } ?>
...
<div class="col-md-6">
   <div class="form-group">
    ...
    <input type="text" name="nome"  value="<?php if(!empty($da)){echo $da->nome;}?>" class="form-control" required>
  </div>
</div>
...
<div class="col-md-4">
   <div class="form-group">
     <label for="exampleInputEmail1">Vencimento <font color="red"><b>*</b></font></label>
    <input type="text" name="vencimento"  value="<?php if(!empty($da)){echo date("d/m/Y",strtotime($da->vencimento));}?>" class="form-control"  id="venc" required>
  </div>
</div>
