...
<div class="container">
    <div class="row">
        <div class=" col-md-12">
            <h1 class="lead text-center" style="border-bottom: 2px solid #68838B">Consulta de Despesas</h1>
        </div>
    </div>
...
<div class="row">
   <div class="col-md-4 col-md-offset-8">
    <?php echo form_open('Welcome/busca_despesas',"class='form-inline'");?>
       <div class="form-group">
            <input type="text" class="form-control"  placeholder="Insira o nome" size="28" name="busca" required>
       </div>
  ...
  <tbody id="tabela">
    ...
    <tr>
      ...
      <td ><?php echo date("d/m/Y",strtotime($a->vencimento));?></td>
        ...
        <td><a href="<?php echo base_url('Welcome/editar_despesas/'.$a->id);?>" class="btn btn-warning" data-toggle="modal">Editar <span class="glyphicon glyphicon-pencil"></span></a></td>
        <td><a href="<?php echo base_url('Welcome/deleta_despesas/'.$a->id);?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Excluir</a></td>
      <?php // }
       }; ?>
    </tr>
  </tbody>
