...
<div class="container">
    <div class="row">
        <div class=" col-md-12"> 
             <h1 class="lead text-center" style="border-bottom:2px solid #68838B">Consulta de Entrada</h1>
        </div>
    </div>
...
<div class="row">
   <div class="col-md-4 col-md-offset-8">
    <?php echo form_open('Welcome/busca_entrada',"class='form-inline'");?>
       <div class="form-group">
            <input type="text" class="form-control"  placeholder="Insira o tipo" size="28" name="busca" required>
       </div>
...
<td><a href="<?php echo base_url('Welcome/editar_entrada/'.$a->id);?>" class="btn btn-warning" data-toggle="modal">Editar <span class="glyphicon glyphicon-pencil"></span></a></td>
      <td><a href="<?php echo base_url('Welcome/deleta_entrada/'.$a->id);?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Excluir</a></td>
      <?php // }
       }; ?>
    </tr>
  </tbody>
