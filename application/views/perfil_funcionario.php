...
<?php //mensagem de erro abaixo
      ...
      <?php echo form_open('Welcome/atualiza_funcionario');?>
...
<div class="col-md-10">
   <div class="form-group">
    ...
    <input type="text" name="nome"  value="<?php echo $this->session->userdata('nome');?>" class="form-control" required >
  </div>
</div>
...
<div class="col-md-4">
 ...
 <label for="exampleInputEmail1">Cargo<font color="red"><b>*</b></font></label>
   ...
   <div class="form-group">
    ...
    <input type="text" name="usuario" class="form-control"  required  value="<?php echo $this->session->userdata('usuario');?>">
  </div>
</div>
...
$(document).ready(function() {
 var tipo="<?php echo $this->session->userdata('perfil');?>";
 $('#se').val(tipo);
});
</script>
